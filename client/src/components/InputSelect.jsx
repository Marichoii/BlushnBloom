    ...
    return (
        <div className="mb-4">
            ...
            <select
                ...
                name={name}
                onChange={onChange}
                className="w-full border border-gray-300 bg-white text-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blush-accent transition"
            >
